...
async def fetch_data(exchange, symbol, timeframe, limit=3000):
...
exchange = ["Binance"]
symbols = ["BTCUSDT", "ETHUSDT","BNBUSDT","SOLUSDT","XRPUSDT","DOGEUSDT","ADAUSDT","AVAXUSDT","TRXUSDT","SHIBUSDT"]  # Ajusta según tus tickers

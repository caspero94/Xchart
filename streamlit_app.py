...
exchange = ["Binance"]
symbols = ["BTCUSDT", "ETHUSDT", "SOLUSDT", "PEPEUSDT", "XRPUSDT", "WIFUSDT", "DOGEUSDT", "BNBUSDT", "ARBUSDT", "ETHFIUSDT", "ENSUSDT", "AVAXUSDT", "NOTUSDT", "BONKUSDT", "FLOKIUSDT", "ZROUSDT", "WLDUSDT", "SHIBUSDT", "RUNEUSDT", "BOMEUSDT","XLMUSDT","PEOPLEUSDT", "ORDIUSDT", "FETUSDT", "STRKUSDT", "ZKUSDT", "MATICUSDT", "NEARUSDT", "OPUSDT", "ADAUSDT", "ENAUSDT", "TIAUSDT", "ETCUSDT", "INJUSDT", "BANANAUSDT", "MKRUSDT", "LDOUSDT", "IOUSDT", "STMXUSDT", "BCHUSDT", "AEVOUSDT", "TRXUSDT","CTKUSDT", "PENDLEUSDT", "LTCUSDT", "SEIUSDT", "ALTUSDT", "RNDRUSDT", "BNXUSDT", "LINKUSDT", "JUPUSDT", "REZUSDT", "BBUSDT", "ICPUSDT", "FTMUSDT", "FILUSDT", "DYDXUSDT", "DOTUSDT", "SUIUSDT", "MEMEUSDT", "JASMYUSDT", "CRVUSDT", "UNIUSDT","CVXUSDT", "RAYUSDT", "APTUSDT", "STXUSDT", "RDNTUSDT", "JTOUSDT", "ARUSDT", "SSVUSDT", "TAOUSDT", "SAGAUSDT", "GALAUSDT", "MANTAUSDT", "LISTAUSDT", "PIXELUSDT", "CFXUSDT", "ARKMUSDT", "COTIUSDT", "HIGHUSDT", "TRBUSDT", "PYTHUSDT", "LUNCUSDT","AAVEUSDT", "HBARUSDT", "TRUUSDT", "CAKEUSDT", "TNSRUSDT", "DYMUSDT", "ATOMUSDT", "CKBUSDT", "EOSUSDT", "METISUSDT", "OMNIUSDT", "WUSDT", "OMUSDT", "GUSDT", "YGGUSDT", "AXLUSDT"]
